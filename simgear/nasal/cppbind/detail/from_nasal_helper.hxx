...
namespace nasal
{
  ...
  T from_nasal_helper(naContext c, naRef ref, const T*)
  {
   ...
   */
  template<class Vec2>
    requires is_vec2<Vec2>::value
  Vec2 from_nasal_helper(naContext c, naRef ref, const Vec2*)
  {
    auto vec =
  ...
  template<class Vec4>
    requires is_vec4<Vec4>::value
  Vec4 from_nasal_helper(naContext c, naRef ref, const Vec4*)
  {
